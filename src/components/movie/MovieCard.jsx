    ...
    >
      ...
      {onRemove && (
        <button
          ...
          className="absolute top-2 right-2 z-10 inline-flex items-center justify-center h-8 w-8 rounded-lg bg-black/60 opacity-0 group-hover:opacity-100 hover:bg-red-600 text-white border border-white/10 transition-all duration-300"
        >
